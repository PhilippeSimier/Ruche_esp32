...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testaprsdma

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/testaprsdma: ${OBJECTFILES}
...
${OBJECTDIR}/DRA818.o: DRA818.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DRA818.o DRA818.cpp

${OBJECTDIR}/DdsI2s.o: DdsI2s.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DdsI2s.o DdsI2s.cpp

${OBJECTDIR}/Fx25.o: Fx25.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fx25.o Fx25.cpp
...
${OBJECTDIR}/Weather.o: Weather.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Weather.o Weather.cpp
